using MessagePack;
using Microsoft.IO;
using RxCats.GameApi.Domain.Dto;
...
public class MessagePackLoggingMiddleware
{
    ...
    private readonly ILogger<MessagePackLoggingMiddleware> _logger;
    private readonly RecyclableMemoryStreamManager _recyclableMemoryStreamManager;

    public MessagePackLoggingMiddleware(RequestDelegate next, ILogger<MessagePackLoggingMiddleware> logger)
    {
        _next = next;
        _logger = logger;
